...
namespace JitIlVerification
{
    internal static class AccessVerificationHelpers
    {
        ...
        private static bool GrantsFriendAccessTo(this Module module, Module friendModule)
        {
            var assembly = module.Assembly;
            if (assembly != null)
            {
                var friendAssembly = friendModule.Assembly;
                ...
                foreach (var attribute in assembly.CustomAttributes.GetDecodedCustomAttributes("System.Runtime.CompilerServices", "InternalsVisibleToAttribute"))
                {
